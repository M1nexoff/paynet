...
-keep class uz.gita.m1nex.core.ResultData$Companion { *; }
-keep class uz.gita.m1nex.core.ResultData$Success { *; }

# Keep Hilt components
-keep class dagger.hilt.** { *; }
-keep class * extends dagger.hilt.android.components.** { *; }
-keep class * extends dagger.hilt.components.** { *; }
-keep class uz.gita.m1nex.core.** { *; }
...
-keep class uz.gita.m1nex.core.di.*
